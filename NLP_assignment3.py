...
# Load Yelp tips data
yelp_tips_file_path = "D:/yelp_academic_dataset_tip.json"
...
model.build_vocab(sentences=processed_texts)
model.train(sentences=processed_texts, total_examples=len(processed_texts), epochs=5)
